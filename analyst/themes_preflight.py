...
THEME_SIGNATURES: dict[str, list[str]] = {
    "cartel_security": [
        "cartel", "cjng", "sinaloa", "chapitos", "mayiza", "mencho",
    ...
    "us_mexico": [
        ...
        "bilateral", "trade", "trump", "state department", "dea",
        "extradition", "fto", "sdn", "sanction", "migration",
        "deportation", "asylum", "cross-border",
    ],
    "energy_infra": [
        "energy", "pemex", "cfe", "electricity", "power", "grid",
        "gas", "natural gas", "water", "utility", "infrastructure",
        "fuel", "refinery", "pipeline", "renewable", "solar",
        "wind", "generation", "transmission", "distribution",
    ],
    "economy_markets": [
        "economy", "market", "peso", "mxn", "fdi", "investment",
        "nearshore", "industrial", "real estate", "construction",
    ...
    "worldcup_travel": [
        ...
        "hotel", "hospitality", "venue", "stadium", "fan",
        "transportation", "mobility", "event security",
    ],
}

# Synonyms used in theme names (so code can look up by human-readable names)
CATEGORY_SYNONYMS: dict[str, list[str]] = {
    "industrial_real_estate": ["real estate", "industrial property", "industrial park", "manufacturing facility", "warehouse", "logistics center", "bajio corridor", "inmobiliario"],
    "violence_outbreak": ["violence outbreak", "attack", "shooting spree", "massacre", "narcobloqueo"],
    "fentanyl_trafficking": ["fentanyl", "precursor", "synthetic drug"],
    "election_monitoring": ["election", "vote", "campaign", "candidate"],
    "legislative_reform": ["reform", "constitutional", "judicial reform", "electoral reform", "energy reform"],
    "energy_infrastructure_investment": ["energy investment", "power plant", "renewable investment", "grid investment"],
    "water_security": ["water", "drought", "water stress", "aquifer"],
    "executive_travel_security": ["travel security", "executive protection", "secure transport"],
    "supply_chain_risk": ["supply chain", "logistics", "cargo", "transport route"],
    "usmca_review": ["usmca", "trade deal", "trade agreement"],
    "tariff_risk": ["tariff", "trade war", "import tax"],
    ...
    "peso_currency_risk": ["peso", "currency", "forex", "mxn usd", "depreciation", "appreciation"],
}
