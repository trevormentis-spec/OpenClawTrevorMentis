...
REGION_KEYWORDS = {
    ...
    "asia": ["china", "taiwan", "japan", "south korea", "north korea", "india",
             "pakistan", "philippines", "vietnam", "australia", "indonesia",
             "south china sea", "spratly", "senkaku", "diaoyu", "quad"],
    "north_america": ["united states", "canada", "mexico", "us-mexico", "trump",
                      "white house", "congress", "pentagon", "state department",
                      "border", "cartel", "fentanyl"],
    "south_central_america": ["brazil", "argentina", "colombia", "chile", "peru",
                              "venezuela", "ecuador", "latin america", "amazon",
                              "lula", "maduro"],
    "global_finance": ["oil", "brent", "wti", "lng", "energy", "sanctions",
...
def inject_into_working_dir(incidents: list[dict], working_dir: pathlib.Path) -> int:
    ...
    if not incidents_file.exists():
        ...
        incidents_file.write_text(json.dumps({
            ...
            "window_hours": 48,
            "regions_covered": list(REGION_KEYWORDS.keys()),
            "incidents": [],
            "collection_gaps": [],
        }, indent=2))
