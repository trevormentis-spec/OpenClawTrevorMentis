...
REGION_KEYWORDS = {
    ...
    "sub_saharan_africa": ["sub-saharan africa", "west africa", "east africa", "nigeria", "kenya",
                           "ethiopia", "south africa", "libya", "algeria", "morocco",
                           "tunisia", "sudan", "somalia", "ghana", "angola",
                           "mozambique", "au", "african union", "nile", "sahel", "maghreb"],
